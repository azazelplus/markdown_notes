...
常用的library有:
	...
	SOURCSTM.olb
	SPECIAL.olb
	opamp.olb(通用运放模型, UA741, LM324四路运放等)
	eval.olb(各种基础原件)


#### lib介绍
说明:本介绍包含了`D:\Cadence\SPB_22.1\tools\capture\library\pspice和capture\library\pspice\advanls`目录下所有库,但由于作者水平有限,介绍得也比较简单,有些说明可能不一定对.请高手指正.谢谢！
