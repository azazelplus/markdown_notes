...
| 名称            	 	| 兼容标准 	  			| 说明                                |
| ------------ --- 		| -------- 				| --------------------------------- |
| **TF卡(micro SD)**    | SD标准        		| 也称为SD小卡. 最初命名为TransFlash，后被SD协会纳入microSD标准. 通过卡套和SD卡互相转换. |
| **SD卡**     	 		| SD标准        		| 也称为SD大卡.        |
| **CFE A卡(CF express)** | PCIe/NVMe 协议        | CFE卡主要用于高端相机. 使用电脑用的PCIe总线. 两种CFE卡通过卡套转换. PCIe协议带来更高的带宽,延迟,并发...  |
| **CFE B卡(CF express)**  | PCIe/NVMe 协议      | 更大.        |
